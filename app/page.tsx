...
const translations = {
  en: {
    ...
    products: {
      title: 'Our Products',
      description: 'Premium abrasive solutions engineered for precision, durability, and superior performance',
      items: [
        {
    ...
    features: [
      {
        ...
        description: 'Built to withstand heavy-duty applications with consistent performance and reliability.',
      },
      {
        title: 'Competitive Pricing',
        description: 'Premium quality at prices that make sense for your bottom line. Volume discounts available.',
      },
      {
        title: 'Expert Support',
        description: 'Our team of abrasive specialists is ready to help you find the perfect solution.',
      },
    ],
    cta: {
  ...
  fa: {
    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'سنباده درجه صنعتی در اندازه‌های مختلف برای آماده‌سازی سطح و تمام‌کاری.',
          learnMore: 'بیشتر بدانید',
        },
        {
          name: 'ترکیبات صیقل‌کاری',
          description: 'ترکیبات صیقل‌کاری حرفه‌ای و پد کوبی برای درخشش و حفاظت بسیار بر هر سطحی.',
          learnMore: 'بیشتر بدانید',
        },
      ],
    },
    features: [
      {
        title: 'درجه صنعتی',
        description: 'ساخته شده برای تحمل کاربردهای سنگین با عملکرد و قابلیت اعتماد ثابت.',
      },
      {
        title: 'قیمت رقابتی',
        description: 'کیفیت بسیار در قیمتی منطقی برای خط پایین شما. تخفیف حجم موجود است.',
      },
      {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-6 ${isRTL ? 'lg:col-start-2' : ''}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-8">
              <a href="#contact" className="flex items-center justify-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors font-semibold">
                {t.hero.getStarted}
                <ArrowRight size={20} />
              </a>
              <a href="mailto:sales@asiasayesh.com" className="flex items-center justify-center gap-2 px-6 py-3 border border-primary/40 rounded-lg hover:border-primary hover:bg-primary/5 transition-colors font-semibold">
                <Mail size={20} />
                {t.hero.emailSales}
              </a>
            </div>
          ...
          {/* Hero Image */}
          <div className={`relative h-96 lg:h-full min-h-96 rounded-lg overflow-hidden border border-border ${isRTL ? 'lg:col-start-1' : ''}`}>
            <Image
              src="/hero-abrasives.png"
      ...
      <section id="products" className="py-20 px-4 bg-card/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4">{t.products.title}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t.products.items.map((product, idx) => (
              <article key={idx} className="group rounded-lg border border-border bg-background overflow-hidden hover:border-primary/50 transition-all duration-300">
                <div className="relative h-64 overflow-hidden bg-card">
                  <Image
                    src={['/product-grinding-wheel.png', '/product-sandpaper.png', '/product-polishing.png'][idx]}
                ...
                <div className="p-6 space-y-3">
                  ...
                  <a href="#contact" className={`inline-flex items-center gap-2 text-primary hover:gap-3 transition-all font-semibold text-sm ${isRTL ? 'flex-row-reverse' : ''}`}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t.features.map((feature, idx) => (
              <div key={idx} className="p-8 rounded-lg border border-border bg-card/50 hover:border-primary/50 transition-colors">
      ...
      <footer className="border-t border-border py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div>
              <h4 className="text-lg font-bold mb-4">{t.footer.companyName}</h4>
              <p className="text-muted-foreground">
